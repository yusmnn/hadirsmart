...
class HrdEditProfileFormView extends StatefulWidget {
  const HrdEditProfileFormView({super.key});
...
class _HrdEditProfileFormViewState extends State<HrdEditProfileFormView> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<HrdEditProfileFormController, HrdEditProfileFormState>(
        listener: (context, state) {},
        child: BlocBuilder<HrdEditProfileFormController, HrdEditProfileFormState>(
  ...
  Widget buildView(
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hrd Edit Profile Form'),
      ),
      body: Column(
