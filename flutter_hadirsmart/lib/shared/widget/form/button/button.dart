...
class _QButtonState extends State<QButton> {
  ...
  Widget build(BuildContext context) {
    ...
    // Gunakan warna bawaan jika tidak diisi
    final buttonColor = widget.color ?? Theme.of(context).primaryColor;
    final disabledButtonColor = Theme.of(context).disabledColor;
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: widget.enabled ? buttonColor : disabledButtonColor,
          // backgroundColor:
