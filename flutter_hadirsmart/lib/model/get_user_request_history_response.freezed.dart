...
mixin _$GetUserRequestHistoryResponse {
  ...
  /// Serializes this GetUserRequestHistoryResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetUserRequestHistoryResponse
...
mixin _$UserRequestHistory {
  ...
  /// Serializes this UserRequestHistory to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UserRequestHistory
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
